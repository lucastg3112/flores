...
eau_indicators = [
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023", "2024"],
                "datasets": [{"label": "PIB per cápita (US$ corrientes)", "data": [45938.6, 37991.7, 44118.5, 50759.8, 49850.7, 50273.5], "borderColor": "#735664", "backgroundColor": "#73566420", "fill": "true"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                ...
                "datasets": [{"label": "Importaciones (US$)", "data": [50354898.73, 45899210.25, 64203566.14, 69741088.09, 78773261.98], "backgroundColor": ["#a8d5ba", "#ba1a1a", "#6c5777", "#735664", "#6c5777"]}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Índice WGI", "data": [0.65, 0.60, 0.61, 0.73, 0.67], "borderColor": "#735664", "backgroundColor": "#ba1a1a20"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Índice de Libertad Económica", "data": [77.6, 76.2, 76.9, 70.2, 70.8], "borderColor": "#6c5777", "backgroundColor": "#a8d5ba20"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Índice de efectividad del gobierno", "data": [1.4, 1.3, 1.38, 1.32, 1.6], "borderColor": "#a8d5ba", "backgroundColor": "#a8d5ba20", "tension": 0.4}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Usuarios de Internet (%)", "data": [99.0, 100, 100, 100, 100], "borderColor": "#ba1a1a", "backgroundColor": "#ba1a1a20"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                ...
                "datasets": [{"label": "Posición mundial", "data": [34, 33, 31, 32, 32], "borderColor": "#ba1a1a", "backgroundColor": "#a8d5ba20"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023", "2024"],
                "datasets": [{"label": "Emisiones (t CO2e)", "data": [26.66732, 26.56611, 26.66825, 25.36906, 24.25728, 24.04322], "borderColor": "#a8d5ba", "backgroundColor": "#6c577720"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Comercio (% del PIB)", "data": [163.8221, 181.2919, 182.9094, 185.7417, 199.045], "borderColor": "#735664", "backgroundColor": "#3d675120", "fill": "true"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Importaciones de bienes y servicios (% del PIB)", "data": [70.52, 83.22, 82.27, 83.69, 92.2], "borderColor": "#ba1a1a", "backgroundColor": "#3d675120"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "Exportaciones de bienes y servicios (% del PIB)", "data": [93.30231, 98.0725, 100.6426, 102.052, 106.8461], "borderColor": "#a8d5ba", "backgroundColor": "#6c577720", "fill": "true"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023"],
                "datasets": [{"label": "IED neta (% del PIB)", "data": [4.119286, 5.567357, 4.892306, 4.445914, 5.87184], "borderColor": "#a8d5ba", "backgroundColor": "#73566420"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023", "2024"],
                "datasets": [{"label": "Capitalización bursátil (% del PIB)", "data": [56.88036, 82.54857, 131.3938, 170.8167, 190.2272, 190.8591], "borderColor": "#a8d5ba", "backgroundColor": "#3d675120", "fill": "true"}]
            },
    ...
    },
    {
        ...
        "chart_config": {
            ...
            "data": {
                "labels": ["2019", "2020", "2021", "2022", "2023", "2024"],
                "datasets": [{"label": "Acciones negociadas (% del PIB)", "data": [6.741077, 10.50203, 28.32565, 28.64126, 21.31852, 21.82124], "borderColor": "#735664", "backgroundColor": "#73566420", "tension": 0.4}]
            },
